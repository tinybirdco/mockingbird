...
const config: DocsThemeConfig = {
  ...
  chat: {
    link: "https://www.tinybird.co/join-our-slack-community",
    icon: (
      <svg
  ...
  docsRepositoryBase:
    "https://github.com/tinybirdco/mockingbird/tree/main/apps/docs",
  footer: {
    content: (
      <span>
        Built by <a href="https://tinybird.co">Tinybird</a>
      </span>
    ),
  },
  head: (
    <>
      ...
      <meta
        ...
        content="Mockingbird Docs: the mock streaming data generator"
      />
    </>
  ),
};
